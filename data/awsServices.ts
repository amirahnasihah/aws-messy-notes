        ...
        services: [
          {
            ...
            tips: [
              'Stateful = SG ingat connections — outbound reply auto dibenarkan, tak perlu explicit outbound rule untuk replies',
              'SG boleh reference SG lain sebagai source — "allow traffic FROM web-sg" (bukan IP range)',
      ...
      },
      {
        ...
        services: [
          ...
          },
          {
            ...
            fungsi: 'CIDR (Classless Inter-Domain Routing) tentukan berapa banyak IP dalam sesebuah network. Kau perlu plan IP ranges SEBELUM create VPC — tak boleh tukar selepas resources dah deployed. AWS reserve 5 IPs setiap subnet: .0 network, .1 VPC router, .2 DNS, .3 future, .255 broadcast.',
            ...
            tips: [
              'Formula: 32 − prefix = bits. 2^bits = total. Tolak 5 = usable',
          ...
          },
          {
            ...
            keywords: ['Transit Gateway', 'hub', 'transitive routing', 'many VPCs', 'replace peering mesh', 'on-premises', 'cross-account'],
          },
          {
