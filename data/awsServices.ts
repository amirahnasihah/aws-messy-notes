    ...
    sections: [
      {
        ...
        services: [
          ...
          },
          {
            ...
            keywords: ['cross-account sharing', 'shared subnets', 'Transit Gateway sharing', 'no resource duplication'],
          },
          {
      ...
      },
      {
        ...
        services: [
          ...
          },
          {
            ...
            ingat: '"Pemburu data sensitif dalam S3"',
            gunaUntuk: 'Discover PII, credentials, financial data accidentally stored in S3',
            fungsi: 'Penemuan data sensitif berasaskan ML dalam S3 (PII, kad kredit, kelayakan).',
      ...
      },
      {
        ...
        services: [
          ...
          },
          {
            ...
            fullName: 'Amazon Redshift — Encryption',
            ingat: '"Data warehouse — KMS untuk at rest, SSL untuk in transit"',
            gunaUntuk: 'Encrypt data warehouse at rest (KMS) and in transit (SSL)',
            fungsi: 'Redshift menyimpan data secara terenkripsi menggunakan KMS (AES-256) untuk data at rest. SSL/TLS encrypt data in transit antara client dan cluster. Redshift TIDAK guna EBS — ia manage storage sendiri.',
            ...
            keywords: ['Redshift', 'KMS', 'encryption at rest', 'SSL TLS', 'in transit', 'AES-256', 'data warehouse'],
          },
          {
            ...
            keywords: ['API audit', 'who did what', 'compliance', 'forensics', 'account activity', '90-day retention'],
          },
          {
            shortName: 'ACM',
            ...
            keywords: ['SSL', 'TLS', 'HTTPS', 'free certificate', 'auto-renewal', 'ALB', 'CloudFront', 'API Gateway'],
          },
          {
            shortName: 'CloudHSM',
            ...
            keywords: ['dedicated HSM', 'FIPS 140-2 Level 3', 'customer control', 'single-tenant', 'hardware security'],
          },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        services: [
          ...
          },
          {
            ...
            fungsi: 'Aurora simpan 6 salinan data merentasi 3 AZs secara automatik. Storage auto-grow hingga 128TB. Up to 15 Read Replicas dengan lag <10ms. Failover automatik dalam <30 saat.',
            ...
            tips: [
              ...
              'Aurora storage auto-grow hingga 128TB — zero storage management',
              'Aurora Global Database: primary + secondary read-only regions untuk global DR',
            ],
            keywords: ['MySQL compatible', 'PostgreSQL compatible', '6 copies', '3 AZs', 'auto storage 128TB', 'fast failover', '15 read replicas'],
          },
          {
            ...
            fungsi: 'Aurora Serverless v2 auto-scale capacity dalam fractions of seconds dari minimum hingga ratusan ACUs. Boleh scale to near-zero bila idle.',
            ...
            keywords: ['scale to zero', 'ACU', 'pay per second', 'intermittent', 'dev/test', 'auto-pause', 'variable traffic'],
          },
          {
            shortName: 'DynamoDB',
            ...
            keywords: ['NoSQL', 'key-value', 'serverless', 'millisecond latency', 'DAX', 'Global Tables', 'streams', 'auto-scale'],
          },
        ],
      },
      {
      ...
      },
      {
        ...
        services: [
          ...
          },
          {
            ...
            keywords: ['Windows SMB', 'NTFS', 'Active Directory', 'Lustre HPC', 'NetApp ONTAP', 'OpenZFS', 'managed file system'],
          },
          {
          ...
          },
          {
            ...
            ingat: '"Pemindah data automatik dan laju — dari on-prem ke AWS"',
            gunaUntuk: 'One-time or recurring data migration from on-premises to S3, EFS, or FSx',
            fungsi: 'Automated data transfer service yang handle scheduling, verification, dan network optimization. Boleh transfer data dari NFS, SMB, HDFS, atau S3-compatible storage ke AWS.',
            ...
            keywords: ['data migration', 'automated transfer', 'S3', 'EFS', 'FSx', 'NFS', 'SMB', 'HDFS', 'one-time migration'],
          },
          {
            shortName: 'DMS',
      ...
      },
      {
        ...
        services: [
          {
            shortName: 'Application Migration Service',
            fullName: 'AWS Application Migration Service (MGN)',
            ingat: '"Angkat server on-prem terus ke EC2 — lift-and-shift"',
            gunaUntuk: 'Rehost physical/virtual servers to AWS EC2 with minimal downtime',
            fungsi: 'Install MGN agent pada source server, ia continuous-replicate ke AWS. Bila ready untuk cutover, launch EC2 instances yang identical. Downtime dalam minit sahaja.',
            scenario: '"Migrate on-premises servers to AWS without re-architecting" → MGN (lift-and-shift). Bukan DMS (yang untuk databases). MGN = server/VM migration. DMS = database migration.',
            keywords: ['lift-and-shift', 'rehost', 'server migration', 'minimal downtime', 'MGN', 'physical to cloud', 'agent-based'],
          },
          {
            shortName: 'Transfer Family',
            fullName: 'AWS Transfer Family',
            ingat: '"SFTP/FTP server yang store terus ke S3"',
            gunaUntuk: 'Legacy FTP/SFTP file transfers stored directly into S3 or EFS — no code changes',
            fungsi: 'Fully managed SFTP, FTP, FTPS, dan AS2 endpoints. Files land directly dalam S3 atau EFS. Partner companies boleh hantar files guna protokol lama tanpa kena tukar workflow.',
            ...
            keywords: ['SFTP', 'FTP', 'FTPS', 'AS2', 'S3 backend', 'EFS backend', 'managed FTP', 'legacy protocol'],
          },
        ],
      },
    ],
      ...
      },
      {
        ...
        services: [
          ...
          },
          {
            ...
            keywords: ['workflow', 'state machine', 'orchestration', 'retry logic', 'error handling', 'Lambda orchestration', 'visual workflow'],
          },
          {
            shortName: 'Amazon MQ',
            fullName: 'Amazon MQ',
      ...
      },
      {
        ...
        services: [
          ...
          },
          {
            ...
            keywords: ['distributed tracing', 'service map', 'latency analysis', 'microservices', 'Lambda tracing', 'bottleneck', 'debugging'],
          },
        ],
      },
      {
      ...
      },
      {
        ...
        services: [
          ...
          },
          {
            ...
            keywords: ['ETL', 'data catalog', 'Spark', 'serverless', 'crawler', 'data lake', 'transform', 'Parquet', 'schema discovery'],
          },
          {
            shortName: 'EMR',
            fullName: 'Amazon EMR',
          ...
          },
          {
            ...
            keywords: ['Kafka', 'managed', 'streaming', 'event streaming', 'migration', 'Kafka API', 'real-time pipeline', 'brokers'],
          },
        ],
      },
    ],
